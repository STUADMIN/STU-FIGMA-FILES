  ...
  return (
		<main className="min-h-dvh bg-white text-gray-900">
			<div className="flex min-h-dvh">
				<aside className="relative hidden w-60 shrink-0 bg-brand-navy text-white md:flex md:flex-col pt-[200px]">
					...
					<nav className="mt-2 grid gap-1 px-2">
						<Link href="/dashboard" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 bg-white/10 font-medium">
							<StuIcon name="dashboard" size={18} className="text-brand-menu-active" aria-label="Dashboard" />
							Dashboard
						</Link>
						<Link href="/tenders" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="tenders" size={18} className="text-white" aria-label="Tenders" />
							Tenders
						</Link>
						<Link href="#" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="projects" size={18} className="text-white" aria-label="Projects" />
							Projects
						</Link>
						<Link href="#" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="health-safety" size={18} className="text-white" aria-label="Health & Safety" />
							Health &amp; Safety
						</Link>
						<Link href="#" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="equipment" size={18} className="text-white" aria-label="Equipment" />
							Equipment
						</Link>
						<Link href="#" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="vehicles" size={18} className="text-white" aria-label="Vehicles" />
							Vehicles
						</Link>
						<Link href="#" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="emissions" size={18} className="text-white" aria-label="Emissions" />
							Emissions
						</Link>
						<Link href="#" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="accounts" size={18} className="text-white" aria-label="Accounts" />
							Accounts
						</Link>
						<Link href="#" className="flex items-center gap-3 rounded-md px-4 py-3 text-sm transition-colors hover:bg-white/10 opacity-90">
							<StuIcon name="hr" size={18} className="text-white" aria-label="HR" />
							HR
						</Link>
					</nav>
					<div className="mt-auto p-4 text-sm opacity-80">
						<Link href="#" className="flex items-center gap-3">
							<svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
								<circle cx="12" cy="12" r="10" stroke="white" strokeWidth="1.5" fill="none" />
								<path d="M9.75 9.5C10.0833 8.16667 11.0833 7.5 12.75 7.5C14.75 7.5 16 8.5 16 10C16 11 15.5 11.6667 14 12.5C12.5 13.3333 12.5 14 12.5 15" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
				...
				<section className="flex-1">
							...
							<div className="flex h-20 items-center justify-between px-5">
								<div className="relative">
									...
									<svg
										...
										className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-black order-0 grow-0 shrink-0"
									>
					...
					<div className="mx-auto max-w-7xl px-6 py-6">
						...
						<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-tenders bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="tenders" size={84} className="text-brand-tenders" aria-label="Tenders" />
										</div>
										<h3
											className="order-0 self-stretch w-[386px] h-[28px] flex-none font-bold text-[20px] leading-[28px] text-[#0D2352]"
											style={{ fontFamily: "var(--font-montserrat)" }}
										>
											Tenders
										</h3>
										<p className="text-xs text-gray-500 mt-1">
											In Progress <span className="font-semibold">11</span>
											<span className="mx-1">•</span>
											Submitted <span className="font-semibold">10</span>
										</p>
									</div>
									<Link href="/tenders" className="absolute right-7 bottom-7 flex h-8 w-[90px] items-center justify-center gap-1 border border-[var(--Platinum-4,#D0D0D0)] rounded px-4 py-1 text-sm text-[#5D5D5C] bg-white">
										Manage
        </Link>
								</div>
							</div>
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-projects bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="projects" size={84} className="text-brand-projects" aria-label="Projects" />
										</div>
									...
									<button className="absolute right-7 bottom-7 flex h-8 w-[90px] items-center justify-center gap-1 border border-[var(--Platinum-4,#D0D0D0)] rounded px-4 py-1 text-sm text-[#5D5D5C] bg-white cursor-not-allowed opacity-60" disabled>
										Manage
									</button>
								</div>
							</div>
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-hns bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="health-safety" size={84} className="text-brand-hns" aria-label="Health & Safety" />
										</div>
										<h3 className="text-lg font-semibold leading-tight">Health &amp; Safety</h3>
										<p className="text-xs text-gray-500 mt-1">
											In Progress <span className="font-semibold">11</span>
											<span className="mx-1">•</span>
											Submitted <span className="font-semibold">10</span>
							...
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-equipment bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="equipment" size={84} className="text-brand-navy" aria-label="Equipment" />
										</div>
										<h3 className="text-lg font-semibold leading-tight">Equipment</h3>
										<p className="text-xs text-gray-500 mt-1">
											In Progress <span className="font-semibold">11</span>
											<span className="mx-1">•</span>
											Submitted <span className="font-semibold">10</span>
							...
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-vehicles bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="vehicles" size={84} className="text-brand-vehicles" aria-label="Vehicles" />
										</div>
										<h3 className="text-lg font-semibold leading-tight">Vehicles</h3>
										<p className="text-xs text-gray-500 mt-1">
											In Progress <span className="font-semibold">11</span>
											<span className="mx-1">•</span>
											Submitted <span className="font-semibold">10</span>
							...
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-emissions bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="emissions" size={84} className="text-brand-emissions" aria-label="Emissions" />
										</div>
										<h3 className="text-lg font-semibold leading-tight">Emissions</h3>
										<p className="text-xs text-gray-500 mt-1">
											In Progress <span className="font-semibold">11</span>
											<span className="mx-1">•</span>
											Submitted <span className="font-semibold">10</span>
							...
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-accounts bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="accounts" size={84} className="text-brand-accounts" aria-label="Accounts" />
										</div>
										<h3 className="text-lg font-semibold leading-tight">Accounts</h3>
										<p className="text-xs text-gray-500 mt-1">
											In Progress <span className="font-semibold">11</span>
											<span className="mx-1">•</span>
											Submitted <span className="font-semibold">10</span>
							...
							<div className="relative flex flex-col items-start gap-3 rounded-card border border-brand-hr bg-white p-card shadow-sm h-[216px] w-full md:w-[544px]">
								<div className="flex items-start justify-between">
									<div className="flex flex-col items-start gap-2">
										<div className="flex-none order-0 grow-0 grid h-[84px] w-[84px] place-items-center rounded-lg">
											<StuIcon name="hr" size={84} className="text-brand-hr" aria-label="HR" />
										</div>
										<h3 className="text-lg font-semibold leading-tight">HR</h3>
										<p className="text-xs text-gray-500 mt-1">
											In Progress <span className="font-semibold">11</span>
											<span className="mx-1">•</span>
											Submitted <span className="font-semibold">10</span>
