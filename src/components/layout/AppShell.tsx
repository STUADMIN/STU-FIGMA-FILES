...
export default function AppShell({ children, userDisplayName, fullWidth = false }: AppShellProps) {
  ...
  const contentWrapperClasses = fullWidth ? "w-full px-0 pb-6" : "mx-auto w-full max-w-7xl px-6 py-6";
  const navWrapperClasses = "flex h-20 w-full items-center justify-between px-7";
